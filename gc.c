 ...
 */
void
rb_objspace_each_objects(rb_objspace_t *objspace,
			 int (*callback)(void *vstart, void *vend,
			 ...
			 void *data)
{
    ...
    if (!objspace) objspace = &rb_objspace;
    i = 0;
    while (i < heaps_used) {
...
os_obj_of(rb_objspace_t *objspace, VALUE of)
{
    ...
    oes.num = 0;
    oes.of = of;
    rb_objspace_each_objects(objspace, os_obj_of_i, &oes);
